...
def main():
    ...
    # print('dispnet :',disp_net)
    # print('posenet :',pose_exp_net)
    # sys.exit()
...
def train(args, train_loader, disp_net, pose_exp_net,optimizer, epoch_size,  train_writer):
    ...
    for i, data in enumerate(train_loader):
        ...
        #print('disparities',np.shape(disparities[0]))  # b,1,480,640 
        ...
        if w3 > 0:
            ...
            loss_3 = args.smooth_loss(depth)#args.smooth_loss(depth)   batch size
            #print(np.shape(loss_3), loss_3)
            loss_3=loss_3.mean()  #mean batch size
            # print(loss_3)
...
def validate_with_gt(args, val_loader, disp_net, pose_exp_net, epoch, output_writers=[]):
    ...
    if log_outputs:
        ...
        print('111111',len(val_loader),len(output_writers),log_freq)
